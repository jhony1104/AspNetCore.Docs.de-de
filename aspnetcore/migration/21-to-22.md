...
Das in-Process-hosting-Modell wird nicht für ASP.NET Core-apps unterstützt, die auf .NET Framework abzielen.
...
Wenn die app nicht aufruft `CreateDefaultBuilder`, rufen Sie <xref:Microsoft.AspNetCore.Hosting.WebHostBuilderKestrelExtensions.UseKestrel*> **vor** Aufrufen `ConfigureKestrel`:
