...
### <a name="systemruntimeserialization-attributes-not-supported"></a>System. Runtime. Serialization-Attribute werden nicht unterstützt.

Die Attribute [[DataContract]](xref:System.Runtime.Serialization.DataContractAttribute) und [[DataMember]](xref:System.Runtime.Serialization.DataMemberAttribute) werden in `System.Text.Json`nicht unterstützt. Weitere Informationen finden Sie in der GitHub-Ausgabe [System. Text. JSON-Unterstützung für System. Runtime. Serialization](https://github.com/dotnet/corefx/issues/38758).
