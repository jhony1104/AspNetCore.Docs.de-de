...
In 3.0 ist die Runtime-Kompilierung ein opt-in-Szenario. Um die Runtime-Kompilierung zu aktivieren, finden Sie unter https://docs.microsoft.com/aspnet/core/mvc/views/view-compilation?view=aspnetcore-3.0#runtime-compilation.
