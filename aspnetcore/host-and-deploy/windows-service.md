...
* Sie legt den Inhaltsstamm fest.
...
1. Öffnen Sie den Editor für lokale Sicherheitsrichtlinien, indem Sie die Datei *secpool.msc* ausführen.
...
So konfigurieren Sie Dienste mit einem sicheren Endpunkt:
