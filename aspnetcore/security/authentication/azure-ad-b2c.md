...
Um die zugrunde liegenden Optionen direkt konfigurieren zu können, verwenden Sie die entsprechenden Schema-Konstante in `Startup.ConfigureServices`:
