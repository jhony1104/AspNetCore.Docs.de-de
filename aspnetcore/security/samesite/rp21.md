...
---
# <a name="aspnet-core-21-razor-pages-samesite-cookie-sample"></a>Beispiel für Razor "ASP.net Core 2,1 pages SameSite Cookie"
...
Im vorangehenden Code legen sowohl die Cookie-als auch der Sitzungs Status Ihr SameSite `None`-Attribut auf fest, wobei `None` das-Attribut mit einem-Wert ausgegeben und `true`das Secure-Attribut auf festgelegt wird.
