...
Im folgenden `WeatherForecastController` wird protokolliert, <xref:Microsoft.AspNetCore.Identity.IdentityUser%601.UserName> Wenn die- `Get` Methode aufgerufen wird:
