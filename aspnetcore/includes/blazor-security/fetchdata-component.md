<span data-ttu-id="15c3e-101">Die `FetchData` Komponente zeigt, wie:</span><span class="sxs-lookup"><span data-stu-id="15c3e-101">The `FetchData` component shows how to:</span></span>
