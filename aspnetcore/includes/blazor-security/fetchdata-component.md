<span data-ttu-id="8371d-101">Die- `FetchData` Komponente zeigt Folgendes:</span><span class="sxs-lookup"><span data-stu-id="8371d-101">The `FetchData` component shows how to:</span></span>
