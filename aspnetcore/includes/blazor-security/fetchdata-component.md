<span data-ttu-id="e915b-101">Die `FetchData` -Komponente zeigt Folgendes:</span><span class="sxs-lookup"><span data-stu-id="e915b-101">The `FetchData` component shows how to:</span></span>
