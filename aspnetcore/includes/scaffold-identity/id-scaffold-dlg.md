<span data-ttu-id="bd24f-101">Führen Sie das Identitäts Gerüst aus:</span><span class="sxs-lookup"><span data-stu-id="bd24f-101">Run the Identity scaffolder:</span></span>
