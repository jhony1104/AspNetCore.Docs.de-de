<span data-ttu-id="4076d-101">Führen Sie das Identitäts Gerüst aus:</span><span class="sxs-lookup"><span data-stu-id="4076d-101">Run the Identity scaffolder:</span></span>
