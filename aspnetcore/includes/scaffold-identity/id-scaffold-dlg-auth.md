<span data-ttu-id="da648-101">Führen Sie die Identity-gerüstbauer:</span><span class="sxs-lookup"><span data-stu-id="da648-101">Run the Identity scaffolder:</span></span>
