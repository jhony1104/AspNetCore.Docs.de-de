<span data-ttu-id="5bb07-101">Führen Sie die folgenden .NET Core-CLI-Befehle aus:</span><span class="sxs-lookup"><span data-stu-id="5bb07-101">Run the following .NET Core CLI commands:</span></span>
