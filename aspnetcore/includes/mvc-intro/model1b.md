<span data-ttu-id="dac8d-101">Fügen Sie der Klasse `Movie` die folgenden Eigenschaften hinzu:</span><span class="sxs-lookup"><span data-stu-id="dac8d-101">Add the following properties to the `Movie` class:</span></span>
