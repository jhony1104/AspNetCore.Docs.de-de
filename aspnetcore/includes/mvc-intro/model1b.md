<span data-ttu-id="d92a5-101">Fügen Sie der Klasse `Movie` die folgenden Eigenschaften hinzu:</span><span class="sxs-lookup"><span data-stu-id="d92a5-101">Add the following properties to the `Movie` class:</span></span>
