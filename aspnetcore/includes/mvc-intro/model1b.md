<span data-ttu-id="db715-101">Fügen Sie der Klasse `Movie` die folgenden Eigenschaften hinzu:</span><span class="sxs-lookup"><span data-stu-id="db715-101">Add the following properties to the `Movie` class:</span></span>
